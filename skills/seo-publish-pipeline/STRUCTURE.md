...
Fixed order. Every article, every intent. Sections marked (adapt) change
shape with intent; the rest are literal.
...
2. **Short answer** - 2-4 sentences directly under the title answering the
   ...
   snippet and AI-overview candidate.
...
4. **Clear sections (adapt)** - body sections shaped by intent:
   ...
   - buying guide: decision criteria, picks per use case, what to skip
   - troubleshooting: symptom, cause, fix, verify; ordered by likelihood
   - list: ranked with stated ranking basis, 2-3 sentences of why per item

5. **FAQ** - 3-6 real questions (People Also Ask phrasing, GSC queries via
   `vdr sites:gsc-performance`). One-paragraph answers. No questions invented
   to stuff keywords.
